      ...
      >
        <div className="flex flex-col-reverse md:flex-row justify-center items-center lg:text-left h-full gap-x-24 lg:pt-32">
          <motion.div
            ...
            transition={transition1}
            className="md:flex-1 md:flex justify-center items-center max-h-96 lg:max-w-max"
          >
          ...
          <motion.div
            ...
            onMouseEnter={mouseEnterHandler}
            onMouseLeave={mouseLeaveHandler}
            className="md:flex-1 flex flex-col justify-center items-center md:items-start max-[485px]:mt-28 max-[375px]:mt-64"
          >
